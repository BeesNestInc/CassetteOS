...
readonly CASA_UNZIP_TEMP_FOLDER=/tmp/cassetteos
readonly CASA_BIN=cassetteos
readonly CASA_BIN_PATH=/usr/bin/cassetteos
readonly CASA_CONF_PATH=/etc/cassetteos.conf
readonly CASA_SERVICE_PATH=/etc/systemd/system/cassetteos.service
readonly CASA_HELPER_PATH=/usr/share/cassetteos/shell/
readonly CASA_USER_CONF_PATH=/var/lib/cassetteos/conf/
readonly CASA_DB_PATH=/var/lib/cassetteos/db/
readonly CASA_TEMP_PATH=/var/lib/cassetteos/temp/
...
Check_Exist() {
    ...
    ${sudo_cmd} rm -rf /usr/lib/systemd/system/cassetteos.service
    
    ${sudo_cmd} rm -rf /lib/systemd/system/cassetteos.service
